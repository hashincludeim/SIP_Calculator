...
# Header
st.markdown('<h1 class="main-header">Investment Comparison Tool</h1>', unsafe_allow_html=True)
...
<div class="results-card">
    ...
    <p>This tool helps you compare two different investment scenarios side by side. You can analyze:</p>
    <ul>
